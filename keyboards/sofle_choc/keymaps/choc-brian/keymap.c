...
const uint16_t PROGMEM CM_L_1[] = {KC_T,KC_SPC,COMBO_END};
const uint16_t PROGMEM CM_L_2[] = {KC_R,KC_SPC,COMBO_END};
const uint16_t PROGMEM CM_L_3[] = {KC_H,KC_SPC,COMBO_END};
const uint16_t PROGMEM CM_R_1[] = {KC_A,KC_N,COMBO_END};
const uint16_t PROGMEM CM_R_2[] = {KC_E,KC_N,COMBO_END};
const uint16_t PROGMEM CM_R_3[] = {KC_C,KC_N,COMBO_END};

const uint16_t PROGMEM CM_L_4[] = {KC_T,KC_ENT,COMBO_END};
const uint16_t PROGMEM CM_L_5[] = {KC_R,KC_ENT,COMBO_END};
const uint16_t PROGMEM CM_L_6[] = {KC_H,KC_ENT,COMBO_END};
const uint16_t PROGMEM CM_R_4[] = {KC_A,OSL(3),COMBO_END};
const uint16_t PROGMEM CM_R_5[] = {KC_E,OSL(3),COMBO_END};
const uint16_t PROGMEM CM_R_6[] = {KC_C,OSL(3),COMBO_END};


const uint16_t PROGMEM CM_A[] = {KC_T,KC_R,COMBO_END};
const uint16_t PROGMEM CM_B[] = {KC_E,KC_A,COMBO_END};

combo_t key_combos[] = {
    COMBO(CM_L_1, KC_LBRC),    // ? -> [
    COMBO(CM_L_2, S(KC_LBRC)), // ? -> {
    COMBO(CM_L_3, S(KC_9)),    // ? -> (
    COMBO(CM_R_1, KC_LBRC),    // ? -> [
    COMBO(CM_R_2, S(KC_LBRC)), // ? -> {
    COMBO(CM_R_3, S(KC_9)),    // ? -> (

    COMBO(CM_L_4, KC_RBRC),    // ? -> ]
    COMBO(CM_L_5, S(KC_RBRC)), // ? ->
    COMBO(CM_L_6, S(KC_0)),    // ? ->
    COMBO(CM_R_4, KC_RBRC),    // ? ->
    COMBO(CM_R_5, S(KC_RBRC)), // ? ->
    COMBO(CM_R_6, S(KC_0)),    // ? ->


    COMBO(CM_A, OSM(MOD_LSFT)),
    COMBO(CM_B, OSM(MOD_LSFT)),
};
