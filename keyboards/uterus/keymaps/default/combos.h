...
#define SPLIT_OUT_OUTER KC_Z, KC_C
...
MIRRORED_COMB_3(__EXCLAIM,    KC_EXLM,   SPLIT_1, SPLIT_6, SPLIT_INNER)
...
MIRRORED_COMB_3(RIGHT,  KC_RIGHT,       SPLIT_1, SPLIT_5, SPLIT_OUTER)

MIRRORED_COMB_2(CTRL,   OSM(MOD_LCTL),  SPLIT_2, SPLIT_6)
MIRRORED_COMB_3(DOWN,   KC_DOWN,        SPLIT_2, SPLIT_6, SPLIT_OUTER)

MIRRORED_COMB_2(ALT,    OSM(MOD_LALT),  SPLIT_3, SPLIT_7)
MIRRORED_COMB_3(UP,     KC_UP,          SPLIT_3, SPLIT_7, SPLIT_OUTER)

MIRRORED_COMB_2(GUI,    OSM(MOD_LGUI),  SPLIT_4, SPLIT_8)
MIRRORED_COMB_3(LEFT,   KC_LEFT,        SPLIT_4, SPLIT_8, SPLIT_OUTER)

// KC_COPY, KC_PASTE only work on linux
MIRRORED_COMB_2(COPY,   LCTL(KC_C),     SPLIT_6, SPLIT_OUT_OUTER)
MIRRORED_COMB_2(PASTE,  LCTL(KC_V),     SPLIT_5, SPLIT_OUT_OUTER)

MIRRORED_COMB_3(F1_,      KC_F1,         SPLIT_5, SPLIT_7, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F2_,      KC_F2,         SPLIT_6, SPLIT_7, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F3_,      KC_F3,         SPLIT_6, SPLIT_8, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F4_,      KC_F4,         SPLIT_7, SPLIT_8, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F5_,      KC_F5,         SPLIT_1, SPLIT_2, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F6_,      KC_F6,         SPLIT_1, SPLIT_3, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F7_,      KC_F7,         SPLIT_2, SPLIT_3, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F8_,      KC_F8,         SPLIT_2, SPLIT_4, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F9_,      KC_F9,         SPLIT_3, SPLIT_4, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F10_,     KC_F10,        SPLIT_5, SPLIT_6, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F11_,     KC_F11,        SPLIT_5, SPLIT_8, SPLIT_OUT_OUTER)
MIRRORED_COMB_3(F12_,     KC_F12,        SPLIT_1, SPLIT_4, SPLIT_OUT_OUTER)
