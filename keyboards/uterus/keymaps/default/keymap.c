...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
		...
		KC_TAB,  KC_S,	KC_T,   KC_R,	KC_N,	OSM(MOD_LGUI),
		KC_BSPC, KC_I,  KC_A,	KC_E,   KC_O,	KC_DEL,	XXXXXXX,
		KC_LSFT, KC_P1, KC_P2,	KC_P3,  KC_P4,	KC_P5,	XXXXXXX,
 LM(2,MOD_LCTL), KC_P1, KC_P2,	KC_P3,  KC_ENT,	KC_SPC,	KC_P6,

				    KC_F6,  KC_F7,	KC_F8,  KC_F9,	KC_F10,	KC_F11,
		    OSM(MOD_LGUI),  KC_N,	KC_R,   KC_T,	KC_S,	KC_F12,
		XXXXXXX,    KC_DEL,	KC_O,   KC_E,	KC_A,   KC_I,	KC_BSPC,
		XXXXXXX,	KC_P1,  KC_P2,	KC_P3,  KC_P4,	KC_P5,	KC_P6,
