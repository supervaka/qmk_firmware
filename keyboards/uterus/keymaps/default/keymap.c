...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_UTERUS(
        ...
        KC_LSFT,    KC_LGUI,  KC_LEFT,  KC_UP,    KC_RIGHT,	KC_P5,	    LM_LCTL,    
        LM_LCTL,    KC_LGUI,  KC_LALT,  KC_DOWN,  KC_ENT,	KC_SPC,	    OSM_LGUI, 

				    KC_F6,    KC_F7,	KC_F8,    KC_F9,	KC_F10,	    KC_F11,
		            OSM_LGUI, KC_N,	    KC_R,     KC_T,	    KC_S,	    KC_F12,
		XXXXXXX,    KC_DEL,	  KC_O,     KC_E,     KC_A,     KC_I,	    KC_BSPC,
		XXXXXXX,	XXXXXXX,  KC_LEFT,  KC_UP,	  KC_RIGHT,	KC_PGUP,	KC_PSCR,
		OSM_LGUI, 	KC_SPC,   KC_ENT,	KC_DOWN,  KC_HOME,  KC_PGDN,    KC_END
	),
    [1] = LAYOUT_UTERUS(
